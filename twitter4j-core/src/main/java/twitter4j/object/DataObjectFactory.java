 ...
 * @deprecated use {@link twitter4j.object.TwitterObjectFactory} instead
 */
public final class DataObjectFactory {
     ...
     * @throws TwitterException when provided string is not a valid JSON string.
     * @since Twitter4J 2.1.9
     * @deprecated use {@link twitter4j.object.TwitterObjectFactory#createObject(String)} instead
     */
