...
import twitter4j.object.AccountSettings;
import twitter4j.object.Category;
import twitter4j.object.DirectMessage;
import twitter4j.object.Friendship;
import twitter4j.object.IDs;
import twitter4j.object.Location;
import twitter4j.object.OEmbed;
import twitter4j.object.OEmbedRequest;
import twitter4j.object.Relationship;
import twitter4j.object.SavedSearch;
import twitter4j.object.Trends;
import twitter4j.object.UploadedMedia;
import twitter4j.object.UserList;
import twitter4j.response.PagableResponseList;
import twitter4j.response.RateLimitStatus;
import twitter4j.response.ResponseList;
import twitter4j.user.GeoLocation;
import twitter4j.user.GeoQuery;
import twitter4j.user.Place;
import twitter4j.user.Query;
import twitter4j.user.QueryResult;
import twitter4j.user.Status;
import twitter4j.user.StatusUpdate;
import twitter4j.user.User;
