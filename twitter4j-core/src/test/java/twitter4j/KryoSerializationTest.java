...
public class KryoSerializationTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        kryo.register(twitter4j.entity.HashtagEntity[].class);
        kryo.register(twitter4j.entity.URLEntity[].class);
        kryo.register(twitter4j.entity.MediaEntity[].class);
        kryo.register(twitter4j.entity.SymbolEntity[].class);
        kryo.register(twitter4j.entity.UserMentionEntity[].class);
